...
class QAAgent(AgentBase):
    """Audit rubric adherence and identify question IDs needing correction."""
    ...
    def parse_result(result: Result) -> str:
        """Render QA errors in a form that can guide a targeted regrade."""
        text = (
