...
# Define any custom tools here that can be used by the agents in the workflow.
...
def validate_score_constraints(sub_scores: str, max_possible_score: float, total_awarded_score: float) -> str:
    """
    Validates that the sum of the sub-scores exactly matches the total awarded score, and that it does not exceed the maximum possible score for the question.
