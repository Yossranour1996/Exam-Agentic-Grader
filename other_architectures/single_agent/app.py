# other_architectures/single_agent/app.py
...
from single_agent.core.state import InputState, Context
from single_agent.graph.workflow import build_graph
...
def get_config(config_dir: str = "single_agent/core") -> dict:
